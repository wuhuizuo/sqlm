...
// RecordTest record for unit testing
// +--------------+---------------+------+-----+-------------------+----------------+------------+
...
// TableTest for unit testing
type TableTest Table

// RowModel model for store
func (t *TableTest) RowModel() interface{} {
	return &RecordTest{}
}

// Schema of table
func (t *TableTest) Schema() *TableSchema {
	return Schema(t, (*Table)(t))
}

// Create of table
func (t *TableTest) Create() error {
	return Create(t)
}

// IsDup record in Table?
func (t *TableTest) IsDup(record interface{}) (interface{}, error) {
	return IsDup(t, record)
}

// Insert record to Table
func (t *TableTest) Insert(record interface{}) (int64, error) {
	return Insert(t, record)
}

// Inserts records to Table
func (t *TableTest) Inserts(records []interface{}) ([]int64, error) {
	return Inserts(t, records)
}

// Delete records from Table
func (t *TableTest) Delete(filter RowFilter) error {
	return Delete(t, filter)
}

// Save record
func (t *TableTest) Save(record interface{}) error {
	return Save(t, record)
}

// Update records in Table
func (t *TableTest) Update(filter RowFilter, updateParts map[string]interface{}) error {
	return Update(t, filter, updateParts)
}

// List records from Table
func (t *TableTest) List(filter RowFilter, options ListOptions) ([]interface{}, error) {
	return List(t, filter, options)
}

// Get record by Key
func (t *TableTest) Get(filter RowFilter, record interface{}) error {
	return GetFirst(t, filter, record)
}

// ScanRow scan struct from table row
func (t *TableTest) ScanRow(rows *sqlx.Rows) (interface{}, error) {
